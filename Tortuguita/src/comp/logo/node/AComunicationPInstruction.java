...
public final class AComunicationPInstruction extends PPInstruction
{
    private PPCommunication _pCommunication_;

    public AComunicationPInstruction()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AComunicationPInstruction(
            cloneNode(this._pCommunication_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAComunicationPInstruction(this);
    }
