...
public final class AMultListPMultList extends PPMultList
{
    private TMult _mult_;
    private PPValue _pValue_;
    private PPMultList _pMultList_;

    public AMultListPMultList()
    {
        // Constructor
    }
    ...
    public AMultListPMultList(
        ...
        @SuppressWarnings("hiding") PPMultList _pMultList_)
    {
        // Constructor
        setMult(_mult_);
    ...
    public Object clone()
    {
        return new AMultListPMultList(
            cloneNode(this._mult_),
            cloneNode(this._pValue_),
            cloneNode(this._pMultList_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAMultListPMultList(this);
    }
