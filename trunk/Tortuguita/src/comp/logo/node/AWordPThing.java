...
public final class AWordPThing extends PPThing
{
    ...
    public AWordPThing(
        @SuppressWarnings("hiding") PPWord _pWord_)
    {
        // Constructor
        setPWord(_pWord_);
    ...
    public Object clone()
    {
        return new AWordPThing(
            cloneNode(this._pWord_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAWordPThing(this);
    }
