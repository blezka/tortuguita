...
public final class AValueListPValueList extends PPValueList
{
    private PPValue _pValue_;
    private PPValueList _pValueList_;

    public AValueListPValueList()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AValueListPValueList(
    ...
    {
        ((Analysis) sw).caseAValueListPValueList(this);
    }
